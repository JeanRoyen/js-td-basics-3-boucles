...
const tableMax = prompt("Jusque quelle table souhaitez vous aller ?");
const tableValor = prompt("Combien de valeur souhaitez vous pour chaque table ?");

for (let i = 1; i <= tableMax; i++) {
    for (let j = 1; j <= tableValor; j++){
        console.log(i + "*" + j + "=" + i*j);
    }
}